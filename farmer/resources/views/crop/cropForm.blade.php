<div class="col-md-8">
    <form action="{{ route('crop.store') }}" method="POST">
        ...
        <div class="form-group row">
            <label style="font-size: 1.15em" class="col-sm-6 col-form-label text-white" for="name">Crop Name</label>
            <div class="col-sm-6">
                <input style="border: #4B6F44 solid" type="text" class="form-control" id="name" name="name" placeholder="Enter crop name" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input style="border: #4B6F44 solid" type="text" class="form-control" id="type" name="type" placeholder="Enter crop type" required>
            </div>
        </div>
