...
@section('carousel')
    @component('components.hero')
        {{-- @slot('backgroundImage', 'https://source.unsplash.com/corn-field-under-clear-sky-CetB-bTDBtY') --}}
        @slot('backgroundImage', 'https://source.unsplash.com/brown-hen-on-green-grass-field-during-daytime-_xNiRZWdRvE')
